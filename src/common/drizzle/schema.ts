...
export const CartItemStatus = pgEnum('CartItemStatus', [
  'active',
  'wishlist',
  'out_of_stock',
]);
...
export const productDiscount = pgTable(
  ...
  (productDiscount) => ({
    ...
    productDiscount_product_fkey: foreignKey({
      ...
      .onDelete('cascade')
      .onUpdate('cascade'),
    productDiscount_productId_discountId_unique_idx: uniqueIndex(
      'productDiscount_productId_discountId_key',
...
export const voucherUsage = pgTable(
  ...
  (voucherUsage) => ({
    ...
    voucherUsage_voucher_fkey: foreignKey({
      ...
      .onDelete('cascade')
      .onUpdate('cascade'),
    voucherUsage_voucherId_userId_orderId_unique_idx: uniqueIndex(
      'voucherUsage_voucherId_userId_orderId_key',
